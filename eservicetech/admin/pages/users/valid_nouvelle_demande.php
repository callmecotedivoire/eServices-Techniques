        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Nouvelle demande</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                                    <?php include('includes/validation_nouvelle_demande.php'); ?>
                        </div>
                        <!-- /.col-lg-8 -->
                        <div class="col-lg-4">
                                    <?php include('includes/infos_new_demande.php'); ?>
                            <!-- /.panel -->
                        </div>
